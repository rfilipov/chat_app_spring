...
public class Peer 
{
    ...
    private Queue<String> RecivedMessages = new LinkedList<>();
    private Queue<String> Files = new LinkedList<>();
    private Deque<byte[]> Messages = new LinkedList<>();
    private final Deque<ByteArrayTuple> Chunks = new LinkedList<>();
    private String padding = "!,}{";

    ///test veriables
    private boolean test_check_sum_flag = false;
    private boolean test_faild_to_recend = false;
    ...
    {
        RecivedMessages.add(new String(data, StandardCharsets.UTF_8));
